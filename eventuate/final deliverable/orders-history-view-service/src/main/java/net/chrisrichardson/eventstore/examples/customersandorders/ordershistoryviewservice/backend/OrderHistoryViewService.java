...
public class OrderHistoryViewService {
  ...
  public void updateCustomer(String customerId, String customerName, Money creditLimit) {
    customerViewRepository.updateCustomer(customerId, customerName, creditLimit);
  }
  ...
  public void shipOrder(String customerId, String orderId) {
    customerViewRepository.updateOrderState(customerId, orderId, OrderState.SHIPPED);
    orderViewRepository.updateOrderState(orderId, OrderState.SHIPPED);
  }
}
